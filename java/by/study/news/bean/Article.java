...
public class Article implements Serializable {
	...
	public Article(String title, String brief, String content, String status) {
	...
	public Article(int id, String title, String brief, String content, String status) {
	...
	public Article(int id, String title, String brief, String content, Date date, String status, int userId) {
